...
p_hist <- ggplot(data_processed_after_exclusions_without_nonbinary, aes(x = mean_evaluation)) +
  geom_histogram(binwidth = 1,
                 boundary = 0) +
...
p_hist2 <- ggplot(data_processed_after_exclusions_without_nonbinary_reordered, aes(x = AMP_score)) +
